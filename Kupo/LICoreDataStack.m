...
+ (NSManagedObjectModel *)managedObjectModel {
  ...
  NSString *path = [[NSBundle mainBundle] pathForResource:@"Kupo" ofType:@"momd"];
...
+ (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
  ...
  NSURL *storeURL = [NSURL fileURLWithPath:[[[self class] applicationDocumentsDirectory] stringByAppendingPathComponent:@"Kupo.sqlite"]];
