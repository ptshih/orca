...
#define FM_NETWORK_ERROR @"Scrapboard has encountered a network error. Please check your network connection and try again."
...
// App Delegate Macro
#define APP_DELEGATE ((ScrapboardAppDelegate *)[[UIApplication sharedApplication] delegate])
