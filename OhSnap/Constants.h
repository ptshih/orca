...
#define FM_NETWORK_ERROR @"OhSnap has encountered a network error. Please check your network connection and try again."
...
// App Delegate Macro
#define APP_DELEGATE ((OhSnapAppDelegate *)[[UIApplication sharedApplication] delegate])
