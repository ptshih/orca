...
+ (NSManagedObjectModel *)managedObjectModel {
  ...
  NSString *path = [[NSBundle mainBundle] pathForResource:@"OhSnap" ofType:@"momd"];
...
+ (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
  ...
  NSURL *storeURL = [NSURL fileURLWithPath:[[[self class] applicationDocumentsDirectory] stringByAppendingPathComponent:@"OhSnap.sqlite"]];
