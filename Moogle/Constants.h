...
#define CELL_LIGHT_BLUE_COLOR MOOGLE_LIGHT_BLUE_COLOR
...
#define CELL_UNREAD_COLOR MOOGLE_BLUE_COLOR
#define CELL_COLOR RGBACOLOR(235,235,235,0.8)
#define CELL_SELECTED_COLOR MOOGLE_BLUE_COLOR

// NAV
#define NAV_COLOR_DARK_BLUE RGBCOLOR(62,76,102)

#define MOOGLE_LIGHT_GREEN_COLOR RGBCOLOR(205,225,200)
#define MOOGLE_BLUE_COLOR RGBCOLOR(45.0,147.0,204.0)

// GENERIC COLORS
// FB DARK BLUE 51/78/141
// FB LIGHT BLUE 161/176/206
#define MOOGLE_LIGHT_BLUE_COLOR RGBCOLOR(0,179,249)
